...
export default function Details() {
  ...
  const {countryName} = useParams<CountryNameType>();
  // I can't seem to fix the error in the next line,
  // and using "any" wouldn't be elegant either.
  // So, I'm just gonna use ts-ignore for now.
